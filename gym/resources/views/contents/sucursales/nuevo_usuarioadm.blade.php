<div class="card">
    <div class="card-body">
        <form action="{{ url ('agregar-usuarioadmin')}}" method="POST">
            {{ csrf_field() }}
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error("sucursal") border-danger @enderror" name="sucursal" id="sucursal" required="">
                            ...
                            @foreach ($sucursales as $t)
                                <option value="{{ $t->id }}" {{ $t->id == old("sucursal") ? 'selected': ''}}> {{ $t->nombre }}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error("mensualidad") border-danger @enderror" name="mensualidad" id="mensualidad" disabled required="">
                            <option value="">- Selecciona una opción -</option>
